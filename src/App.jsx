  ...
  return (
    <>
        <div className="w-full h-screen duration-200" style={{backgroundColor: color}}>
          <div className='fixd flex flex-wrap justify-center botom-12 inset-x-0 px-2'>
            <div className='mt-10 flex flex-wrap justify-center gap-3 shadow-lg bg-white px-3 py-2 rounded-3xl'>
